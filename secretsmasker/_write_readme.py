...
base = r'C:\Users\ROG\Downloads\Secrets-masker'
tmp = os.path.join(base, '_readme_tmp.md')
dst = os.path.join(base, 'README.md')
...
os.rename(tmp, dst)
print('README.md created ok, size:', os.path.getsize(dst))
